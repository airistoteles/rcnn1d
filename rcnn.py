...
class _RecCnn():
    ...
    def build_model_cnn(self, X, verbose=False, en_dropout=True, depth=1, pooling=2, num_features=1):
    ...
    def build_model_rcnn(self, X, verbose=False, en_dropout=True, depth=1, pooling=2, num_features=1):
